...
public class MancalaFrame extends JFrame implements ChangeListener {
	...
	public void setTheme(MancalaTheme theme) {
		...
		playerA.setForeground(secondaryColor); 
		playerB.setForeground(secondaryColor);
		playerA_pits.setForeground(secondaryColor);
		playerB_pits.setForeground(secondaryColor);
		repaint();
